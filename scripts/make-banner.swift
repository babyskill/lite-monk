...
draw("Agent Character", x: 270, y: H/2 + 28, size: 76, weight: .bold, color: .white)
draw("A calm desktop character for Dhammapada quotes.", x: 274, y: H/2 - 14,
     size: 26, weight: .regular, color: NSColor(white: 1, alpha: 0.78))
draw("Floating character · click reactions · mindfulness bell", x: 274, y: H/2 - 52,
