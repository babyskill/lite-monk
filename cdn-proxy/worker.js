// LiteMonk pet mirror: serves the community pet library from our own R2 so the
...
const UA = "Mozilla/5.0 (LiteMonk pet mirror)";
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (path === "/") return new Response("LiteMonk pet mirror.", { status: 200 });
